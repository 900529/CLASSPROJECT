...
public class Member {
	...
	/*Member 클래스에 아래 요구사항에 맞는 변수와 메소드를 정의하고, main()메소드 에 해당 메소드를 호출해서 결과 확인
    단 인스턴스의 생성은 생성자를 이용해서 초기화하는 코드를 작성해 봅시다.
		...
		public Member  (String name, String phoneNumber, String major, int gade, String email) {
			this(name, phoneNumber, major, grade, email, "", "");
			
		
			
		public void pintMemberData() {
			System.out.println("이름 : " + name);
			System.out.println("전화번호 : " + phoneNumber);
			System.out.println("전공 :" + major);
			System.out.println(''학년 :"+ grade);
			System.out.println("이메일 :" + email);
			System.out.println("생일(월,일) : " + birth);
