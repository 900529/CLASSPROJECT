...
public class ContactT {
	...
	public ContactT(String name, String phoneNumber, String email, String address, String birthday, String group) {
		this.name = name;
	...
	public String toString() {
		return "ContactT [name=" + name + ", phoneNumber=" + phoneNumber + ", email=" + email + ", address=" + address
