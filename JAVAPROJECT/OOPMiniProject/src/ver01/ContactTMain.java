...
public class ContactTMain {
	...
	public static void main(String[] args) {
		...
		ContactT c1 = new ContactT("최예나", "010-0000-0000", "yena@na.com", "서울시", "19900529", "언홍원");
		...
		while (true) { // * 구간반복
			...
			// 인스턴스 생성
			ContactT c = new ContactT(name, phoneNumber, email, address, birthday, group);
