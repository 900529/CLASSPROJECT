...
select eanme, sal, (sal*12+100) 
from emp;
-- 3. 급여가 2000을 넘는 사원의 이름과 급여를 표현, 급여가 많은 것부터 작은 순으로 출력하시오.
select ename, sal
from emp
where sal >2000, order by sal;
​
...
from emp
sal between 2000 and 3000, dept = 20 or 30
order by ename desc;
​

-- 9. 1981년도에 입사한 사원의 이름과 입사일을 출력하시오. (like 연산자와 와일드카드 사용)
selce ename, hiredate
from emp
where hiredate is '81.%%.%%';
...
from emp
where job is 'CLERK' or 'SALESMAN', sal is not (1600, 950, 1300);
​

-- 15. 커미션이 $500 이상인 사원의 이름과 급여 및 커미션을 출력하시오.
selet ename, sal, comm
form emp
where comm > 500;