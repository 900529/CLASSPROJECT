...
-- 43. 사원 번호가 7788인 사원과 담당 업무가 같은 사원을 표시(사원 이름과 담당업무)
select ename, job 
from emp
...
--     업무가 ANALYST가 아닌 사원들을 표시(사원번호, 이름, 담당 업무, 급여)
...
-- 51. BLAKE와 동일한 부서에 속한 사원의 이름과 입사일을 표시하는 질의 작성 (단 BLAKE 제외)
select ename, hiredate
from emp
where deptno = (select deptno from emp where ename = 'BLAKE') and ename <> 'BLAKE' ;

-- 52. 평균 급여보다 많은 사원들의 사원 번호와 이름을 표시하되, 결과를 급여에 대해서 오름차순으로 정렬
select empno, ename
from emp
